...
@endif
@if($riwayatsaya->rule_id !=45 && $riwayatsaya->rule_id !=46)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatsaya->rule_id != 43 && $riwayatsaya->rule_id != 44 && $riwayatsaya->rule_id != 45 && $riwayatsaya->rule_id != 46)
...
@endif
@if($riwayatsaya->rule_id != 42 && $riwayatsaya->rule_id != 43 && $riwayatsaya->rule_id != 44 && $riwayatsaya->rule_id != 45 && $riwayatsaya->rule_id != 46 )
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatsaya->rule_id != 41 && $riwayatsaya->rule_id != 42 && $riwayatsaya->rule_id != 43 && $riwayatsaya->rule_id != 44 && $riwayatsaya->rule_id != 45 && $riwayatsaya->rule_id != 46)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatsaya->rule_id !=39 && $riwayatsaya->rule_id !=40 && $riwayatsaya->rule_id !=41 && $riwayatsaya->rule_id !=42
...
<div class="activity">
    ...
    <div class="activity-detail">
        ...
        <p>{{$pernyataan[0]->pernyataan_G10}}"<a class="badge badge-primary" href="#">{{$riwayatsaya->gejala_10}}</a>"
    </div>
</div>
@endif
