...
@if($riwayatsaya->rule_id !=18 && $riwayatsaya->rule_id !=19)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatsaya->rule_id !=17 && $riwayatsaya->rule_id !=18 && $riwayatsaya->rule_id !=19)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@if($riwayatsaya->rule_id !=16 && $riwayatsaya->rule_id !=17 && $riwayatsaya->rule_id !=18 && $riwayatsaya->rule_id !=19)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatsaya->rule_id !=15 && $riwayatsaya->rule_id !=16 && $riwayatsaya->rule_id !=17 && $riwayatsaya->rule_id !=18 && $riwayatsaya->rule_id !=19)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
