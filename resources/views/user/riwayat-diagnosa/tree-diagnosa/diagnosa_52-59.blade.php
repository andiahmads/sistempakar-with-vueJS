...
@endif
@if($riwayatsaya->rule_id !=57 && $riwayatsaya->rule_id !=58 && $riwayatsaya->rule_id != 59)
...
@endif
@if($riwayatsaya->rule_id !=56 && $riwayatsaya->rule_id !=57 && $riwayatsaya->rule_id !=58 && $riwayatsaya->rule_id != 59)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatsaya->rule_id !=55 && $riwayatsaya->rule_id !=56 && $riwayatsaya->rule_id !=57 && $riwayatsaya->rule_id !=58 && $riwayatsaya->rule_id != 59)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
