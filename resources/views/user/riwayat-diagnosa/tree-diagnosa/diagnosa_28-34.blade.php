...
@if($riwayatsaya->rule_id !=33 && $riwayatsaya->rule_id !=34)
...
@endif
@if($riwayatsaya->rule_id !=32 && $riwayatsaya->rule_id !=33 && $riwayatsaya->rule_id !=34)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@if($riwayatsaya->rule_id !=31 && $riwayatsaya->rule_id !=32 && $riwayatsaya->rule_id !=33 && $riwayatsaya->rule_id !=34)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
