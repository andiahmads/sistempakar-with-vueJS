...
@if($riwayatsaya->rule_id ==77 || $riwayatsaya->rule_id ==78 || $riwayatsaya->rule_id ==79 || $riwayatsaya->rule_id ==80 || $riwayatsaya->rule_id ==81 || $riwayatsaya->rule_id ==82)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatsaya->rule_id ==78 || $riwayatsaya->rule_id ==79 || $riwayatsaya->rule_id ==80)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
