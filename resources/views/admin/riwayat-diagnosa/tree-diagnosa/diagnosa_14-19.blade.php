...
@if($riwayatdiagnosa->rule_id !=18 && $riwayatdiagnosa->rule_id !=19)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatdiagnosa->rule_id !=17 && $riwayatdiagnosa->rule_id !=18 && $riwayatdiagnosa->rule_id !=19)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@if($riwayatdiagnosa->rule_id !=16 && $riwayatdiagnosa->rule_id !=17 && $riwayatdiagnosa->rule_id !=18 && $riwayatdiagnosa->rule_id !=19)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatdiagnosa->rule_id !=15 && $riwayatdiagnosa->rule_id !=16 && $riwayatdiagnosa->rule_id !=17 && $riwayatdiagnosa->rule_id !=18 && $riwayatdiagnosa->rule_id !=19)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
