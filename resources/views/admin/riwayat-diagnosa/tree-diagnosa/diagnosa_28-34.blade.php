...
@if($riwayatdiagnosa->rule_id !=33 && $riwayatdiagnosa->rule_id !=34)
...
@endif
@if($riwayatdiagnosa->rule_id !=32 && $riwayatdiagnosa->rule_id !=33 && $riwayatdiagnosa->rule_id !=34)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@if($riwayatdiagnosa->rule_id !=31 && $riwayatdiagnosa->rule_id !=32 && $riwayatdiagnosa->rule_id !=33 && $riwayatdiagnosa->rule_id !=34)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
