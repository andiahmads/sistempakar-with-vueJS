...
@if($riwayatdiagnosa->rule_id !=89 && $riwayatdiagnosa->rule_id !=90 && $riwayatdiagnosa->rule_id !=91)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@if($riwayatdiagnosa->rule_id !=88 && $riwayatdiagnosa->rule_id !=89 && $riwayatdiagnosa->rule_id !=90 && $riwayatdiagnosa->rule_id !=91)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@if($riwayatdiagnosa->rule_id !=86 && $riwayatdiagnosa->rule_id !=87 && $riwayatdiagnosa->rule_id !=88 && $riwayatdiagnosa->rule_id !=89 && $riwayatdiagnosa->rule_id !=90 && $riwayatdiagnosa->rule_id !=91)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
