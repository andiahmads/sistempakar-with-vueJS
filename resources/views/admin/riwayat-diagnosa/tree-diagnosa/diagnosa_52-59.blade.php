...
@endif
@if($riwayatdiagnosa->rule_id !=57 && $riwayatdiagnosa->rule_id !=58 && $riwayatdiagnosa->rule_id != 59)
...
@endif
@if($riwayatdiagnosa->rule_id !=56 && $riwayatdiagnosa->rule_id !=57 && $riwayatdiagnosa->rule_id !=58 && $riwayatdiagnosa->rule_id != 59)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatdiagnosa->rule_id !=55 && $riwayatdiagnosa->rule_id !=56 && $riwayatdiagnosa->rule_id !=57 && $riwayatdiagnosa->rule_id !=58 && $riwayatdiagnosa->rule_id != 59)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
