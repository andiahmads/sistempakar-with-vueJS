...
@endif
@if($riwayatdiagnosa->rule_id !=45 && $riwayatdiagnosa->rule_id !=46)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatdiagnosa->rule_id != 43 && $riwayatdiagnosa->rule_id != 44 && $riwayatdiagnosa->rule_id != 45 && $riwayatdiagnosa->rule_id != 46)
...
@endif
@if($riwayatdiagnosa->rule_id != 42 && $riwayatdiagnosa->rule_id != 43 && $riwayatdiagnosa->rule_id != 44 && $riwayatdiagnosa->rule_id != 45 && $riwayatdiagnosa->rule_id != 46 )
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatdiagnosa->rule_id != 41 && $riwayatdiagnosa->rule_id != 42 && $riwayatdiagnosa->rule_id != 43 && $riwayatdiagnosa->rule_id != 44 && $riwayatdiagnosa->rule_id != 45 && $riwayatdiagnosa->rule_id != 46)
<div class="activity">
    <div class="activity-icon bg-primary text-white shadow-primary">
        <i class="fas fa-arrow-alt-circle-down"></i>
    </div>
...
@endif
@if($riwayatdiagnosa->rule_id !=39 && $riwayatdiagnosa->rule_id !=40 && $riwayatdiagnosa->rule_id !=41 && $riwayatdiagnosa->rule_id !=42
...
<div class="activity">
    ...
    <div class="activity-detail">
        <div class="mb-2">
            <span class="text-job">Gejala 10</span>
            <span class="bullet"></span>
        </div>
        <p>{{$pernyataan[0]->pernyataan_G10}}"<a class="badge badge-primary" href="#">{{$riwayatdiagnosa->gejala_10}}</a>"
    </div>
</div>
@endif
